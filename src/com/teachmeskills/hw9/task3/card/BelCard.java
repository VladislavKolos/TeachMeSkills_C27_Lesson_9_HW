 ...
 */
public final class BelCard extends BaseCard implements ITransfer {
    ...
    public BelCard(double amountOnCard, String currency, long id, double minLimit, double maxLimit) {
    ...
    public void transferFromCardToCard(BelCard belCard, MasterCard masterCard, VisaCard visaCard, double transferAmount, double commission) {
        ...
        commission = ((Const.COMMISSION * transferAmount) / 100) * Const.USD;
        belCard.amountOnCard = belCard.amountOnCard - transferAmount - commission;
        ...
        masterCard.amountOnCard = masterCard.amountOnCard + transferAmount;
        System.out.println("MasterCard amount after transfer (USD): " + masterCard.amountOnCard);
        System.out.println("Transfer fee: (BYN) " + commission);
    }
}
